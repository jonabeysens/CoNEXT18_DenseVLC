...
%% Load data
load('exp_raw_data_scenario_1','channel_data_all');
...
%% FIGURE 18 left: Plot normalized throughput for all RXs
kappa = 1.3;
...
%% FIGURE 18 right: Plot normalized system throughput for several kappa values
