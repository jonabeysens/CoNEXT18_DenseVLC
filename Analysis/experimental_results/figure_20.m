...
%% Load data
load('exp_raw_data_scenario_3','channel_data_all');
...
%% FIGURE 20 left: Plot normalized throughput for all RXs
kappa = 1.3;
...
%% FIGURE 20 right: Plot normalized system throughput for several kappa values
